...
namespace StudentRecruiter.Controllers
{
    public class FieldOfStudiesController : Controller
    {
		...
		public FieldOfStudiesController()
		{
        ...
        {
            return View(db.FieldsOfStudies.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            FieldOfStudy fieldOfStudy = db.FieldsOfStudies.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description")] FieldOfStudy fieldOfStudy)
        {
            if (ModelState.IsValid)
            {
                db.FieldsOfStudies.Add(fieldOfStudy);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description")] FieldOfStudy fieldOfStudy)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            FieldOfStudy fieldOfStudy = db.FieldsOfStudies.Find(id);
            db.FieldsOfStudies.Remove(fieldOfStudy);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
